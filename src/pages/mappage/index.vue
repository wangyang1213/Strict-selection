<template>
  <div class="mappage">
    <div class="section">
      <input type="text" v-model="keywords" @input="bindInput" placeholder="搜索" focus="true" />
    </div>
    <scroll-view :scroll-y="true" class="addcont" style="height:500px">
    ...
    <div class="map_container">
      ...
      <map id="map" class="map" scale="16" :longitude="longitude" :latitude='latitude' :markers="markers"></map>
    </div>
  </div>
</template> 
